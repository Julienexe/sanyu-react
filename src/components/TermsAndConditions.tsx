    ...
    <section id="terms" className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="mb-4 text-red-600">Terms and Conditions</h2>
          <div className="w-20 h-1 bg-red-600 mx-auto mb-8" />
          <p className="text-gray-600">Last updated: December 18, 2024</p>
        </div>
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>All donations will be used to support our mission and programs</li>
              <li>We will make every effort to honor donor preferences for specific programs or projects</li>
              <li>Donors may request information about how their contributions are being used</li>
            </ul>
          </div>

          <div>
            <h3 className="text-red-600 mb-4">4. Privacy and Data Protection</h3>
            <p className="text-gray-700">
              We are committed to protecting your privacy. Any personal information collected through our website or donation process will be used solely for the purposes of:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mt-4">
              <li>Processing donations and issuing receipts</li>
              <li>Communicating with donors and volunteers</li>
              <li>Sending updates about our work (with your consent)</li>
              <li>Complying with legal and regulatory requirements</li>
            </ul>
          </div>

          <div>
            <h3 className="text-red-600 mb-4">5. Volunteer Participation</h3>
            <p className="text-gray-700">
              Volunteers who wish to participate in our programs agree to follow our guidelines and code of conduct. We reserve the right to refuse or terminate volunteer participation at our discretion to ensure the safety and wellbeing of those we serve.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-red-600 mb-4">8. External Links</h3>
            <p className="text-gray-700">
              Our website may contain links to external sites. We have no control over the content of those sites and assume no responsibility for them or for any loss or damage that may arise from your use of them.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-red-600 mb-4">10. Contact Information</h3>
            <p className="text-gray-700">
              If you have any questions about these terms and conditions, please contact us at:
            </p>
            <div className="mt-4 text-gray-700">
              <p>Email: info@sanyufoundation.org</p>
              <p>Location: Masaka & Kampala, Uganda</p>
            </div>
          </div>
